...
In order to do something after update, use renderUpdated function to redirect to other page or show the resource updated/some message/anything in the current page.
